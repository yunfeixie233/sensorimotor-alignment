...
class RoboQwen25VL(BaseRoboVLM):
    ...
    def forward_continuous(
        ...
        **kwargs,
        ...
        # print("before insert image, input_embeds", input_embeds.shape)
...
if __name__ == "__main__":
    ...
    # model_name = "/mnt/zjk/jianke_z/huggingface/hub/models--Qwen--Qwen2.5-VL-3B-Instruct/snapshots/c747f21f03e7d0792c30766310bd7d8de17eeeb3"
    ...
    # exit()
    configs = load_config("/mnt/zjk/jianke_z/vlm4vla/configs/calvin_finetune/finetune_qwen25vl-3b_calvin.json")
    use_hand_rgb = False
    model = RoboQwen25VL(
        configs=configs,
