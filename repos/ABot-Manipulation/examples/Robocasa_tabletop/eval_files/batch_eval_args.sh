...
ABot_PYTHON=path_to_ABot_env_python
ROBOCASA_PYTHON=path_to_ROBOCASA_env_python
export PYTHONPATH=$(pwd):${PYTHONPATH}
CKPT_DEFAULT=path_to_ABot_checkpoint
...
LOG_DIR="${OUTPUT_ROOT}/logs/eval_$(date +%Y%m%d_%H%M%S)"
mkdir -p "${LOG_DIR}"
