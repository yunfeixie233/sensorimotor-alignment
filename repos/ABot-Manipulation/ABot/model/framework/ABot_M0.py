...
from ABot.model.modules.action_model.AML_ActionHeader import get_action_model, FlowmatchingActionHead
from ABot.training.trainer_utils.trainer_tools import resize_images
from ABot.model.tools import FRAMEWORK_REGISTRY

from vggt.models.vggt import VGGT
from ABot.model.modules.vggt_tools import preprocess_images, CrossAttention
...
if __name__ == "__main__":
    ...
    parser.add_argument("--config_yaml", type=str, default="./ABot/config/training/ABot_pretrain.yaml", help="Path to YAML config")
