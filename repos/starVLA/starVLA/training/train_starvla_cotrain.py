...
"""Training entrypoint for StarVLA VLA+VLM co-training."""
...
class VLACoTrainer(TrainerUtils):
...
VLAMTrainer = VLACoTrainer


def main(cfg) -> None:
    logger.info("VLA Co-Training :: Warming Up")
