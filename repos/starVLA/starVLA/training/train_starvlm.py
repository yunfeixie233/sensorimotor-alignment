...
"""Training entrypoint for StarVLA VLM-only training."""
...
class VLMTrainer(TrainerUtils):
    ...
    def _log_metrics(self, metrics):
        ...
        if hasattr(self.vlm_train_dataloader, "__len__") and len(self.vlm_train_dataloader):
            metrics["epoch"] = round(self.completed_steps / len(self.vlm_train_dataloader), 2)
