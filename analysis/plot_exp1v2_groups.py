...
GROUP_CSVS = {
    "S": os.path.join(EXP_DIR, "cknna_data_exp1v2_tiny_S", "finetune",
                      f"dtw_{DTW_VERSION}",
                      f"results_groups_dtw_{DTW_VERSION}.csv"),
    "M": os.path.join(EXP_DIR, "cknna_data_exp1v2_tiny_M", "finetune",
                      f"dtw_{DTW_VERSION}",
                      f"results_groups_dtw_{DTW_VERSION}.csv"),
    "L": os.path.join(EXP_DIR, "cknna_data_exp1v2_tiny_L", "finetune",
                      f"dtw_{DTW_VERSION}",
                      f"results_groups_dtw_{DTW_VERSION}.csv"),
}
...
FIG_DIR = os.path.join(EXP_DIR, "exp1v2_tiny_figures")
...
def fig_b_cknna_vs_horizon(data):
    ...
    fig.suptitle(
        ...
        "(N=1000/group, 16 models, feats_A=imgtext, group-specific H_max)",
        fontsize=12, y=1.02,
    )
    fig.tight_layout()
