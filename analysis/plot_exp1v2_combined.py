"""
Plot combined Exp 1v2 results (all groups pooled, N=3000, DTW CKNNA).
...
COMBINED_CSV = os.path.join(
    SCRIPT_DIR, "..",
    "cknna_data_exp1v2_tiny_ALL", "finetune",
    f"dtw_{DTW_VERSION}",
...
FIG_DIR = os.path.join(SCRIPT_DIR, "exp1v2_tiny_figures")
...
def fig_cknna_vs_sr(data, model_meta):
    ...
    fig.suptitle(
        ...
        "(N=3000, S+M+L pooled, shared horizons {1,3,7,15})",
        fontsize=12, y=1.005,
    )
